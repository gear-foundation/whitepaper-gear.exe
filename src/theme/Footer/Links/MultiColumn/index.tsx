...
import { useIsMobile } from "@site/src/lib/hooks/use-media"
import {
  AccordionContent,
  AccordionItem,
  AccordionRoot,
  AccordionTrigger,
} from "@site/src/ui/accordion"
...
function Column({ column }: { column: ColumnType }) {
  ...
  return (
    <div className={clsx("col footer__col", column.className)}>
      {isMobile ? (
        <>
          <AccordionRoot className="" type="multiple">
            <AccordionItem value={column.title.split(" ").join("-")}>
              <AccordionTrigger className="footer__title">
                {column.title}
              </AccordionTrigger>
...
export default function FooterLinksMultiColumn({ columns }: Props): ReactNode {
  return (
    <div className="row footer__links">
      ...
      <div className="col footer__col footer__col--social-mobile">
        <div className="footer__title footer__title--socials-mobile">
          Social media
        </div>
        <ul className="footer__items clean-list">
          ...
          <li className="footer__item">
            ...
            >
              ...
              >
                <path
                  d="M15.5979 8.99852C15.5979 9.91117 15.5215 10.7263 15.4028 11.3031C15.371 11.4575 15.3374 11.589 15.3036 11.6974C15.2698 11.589 15.2362 11.4576 15.2045 11.3033C15.0858 10.7265 15.0094 9.91139 15.0094 8.99852C15.0094 8.08567 15.0858 7.27058 15.2045 6.69375C15.2362 6.53948 15.2699 6.40813 15.3036 6.2998C15.3374 6.40812 15.371 6.53946 15.4028 6.69372C15.5215 7.27053 15.5979 8.08561 15.5979 8.99852Z"
                  stroke="currentColor"
                  strokeWidth="0.8"
                ></path>
                <mask id="path-2-inside-1_173_100" fill="white">
                  <path d="M14.2298 9.00013C14.2298 11.0795 13.3459 12.7659 12.2555 12.7659C11.1652 12.7659 10.2812 11.0795 10.2812 9.00013C10.2812 6.92073 11.165 5.23438 12.2554 5.23438C13.3457 5.23438 14.2296 6.92019 14.2296 9.00013"></path>
                </mask>
                <path
                  d="M13.4298 9.00013C13.4298 9.93712 13.2289 10.7459 12.943 11.2913C12.6373 11.8745 12.3542 11.9659 12.2555 11.9659V13.5659C13.2472 13.5659 13.9513 12.8141 14.3601 12.0342C14.7887 11.2166 15.0298 10.1425 15.0298 9.00013H13.4298ZM12.2555 11.9659C12.1568 11.9659 11.8738 11.8745 11.568 11.2913C11.2821 10.7459 11.0813 9.93712 11.0813 9.00013H9.48125C9.48125 10.1425 9.72234 11.2166 10.151 12.0342C10.5598 12.8141 11.2639 13.5659 12.2555 13.5659V11.9659ZM11.0813 9.00013C11.0813 8.06312 11.2821 7.2543 11.568 6.70889C11.8737 6.12571 12.1567 6.03438 12.2554 6.03438V4.43437C11.2637 4.43437 10.5597 5.18621 10.1509 5.96606C9.72229 6.78368 9.48125 7.85774 9.48125 9.00013H11.0813ZM12.2554 6.03438C12.3542 6.03438 12.6372 6.12574 12.9429 6.70874C13.2288 7.25405 13.4296 8.06284 13.4296 9.00013H15.0296C15.0296 7.85748 14.7886 6.78339 14.3599 5.96581C13.951 5.18592 13.2469 4.43437 12.2554 4.43437V6.03438Z"
                  fill="currentColor"
                  mask="url(#path-2-inside-1_173_100)"
                ></path>
                <path
                  d="M9.49691 9.00007C9.49691 10.9932 7.90332 12.6 5.94852 12.6C3.99373 12.6 2.4 10.9928 2.4 9.00007C2.4 7.00734 3.99363 5.4 5.94852 5.4C7.90343 5.4 9.49691 7.00694 9.49691 9.00007Z"
                  stroke="currentColor"
                  strokeWidth="0.8"
                ></path>
              </svg>
